    ...
    <div class="row">
      <div class="col-md-12">
        <a href="<?php echo $searchResult; ?>">
          < Retour aux résultats</a> </div> </div> <?php } ?> <div class="row">
            <div class="col-md-4 mt-3">
              <img src="<?php echo $book['image']; ?>" class="card-img-top" alt="Image du livre <?php echo $book['title']; ?>" style="max-height: 500px;">
            </div>
...
=======
    <?php $content = ob_get_clean(); ?>
    <?php require('public/index.php'); ?>
>>>>>>> 753720297c81ef417ce47264483efbd5156c4433
